...
\begin{figure}
	...
	\caption[Alternative Merging with SGM Postprocessing with thresholded gradients]{Alternative Merging with SGM Postprocessing while using thresholded gradients.}
